...
const LoginPage = () => {
  ...
  return (
    ...
    >
      <form
        className="col-xs-12 col-md-10 col-lg-10 col-xl-8 ml-md-1 d-flex flex-column justify-content-md-between p-3 p-md-0"
      ...
      >
        ...
        <div className="mt-1">
          <button
            type="submit"
            className="btn btn-large login-btn col-12 py-md-3 py-3"
          >
            Log in
          </button>
        </div>
